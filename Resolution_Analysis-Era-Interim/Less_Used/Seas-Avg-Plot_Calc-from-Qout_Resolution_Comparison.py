...
list_titles = ['AZ Daily Avg: Low vs Med', 'AZ Daily Avg: Low vs High', 'AZ Daily Avg: Med vs High',
               'ID Daily Avg: Low vs Med', 'ID Daily Avg: Low vs High', 'ID Daily Avg: Med vs High',
               'MO Daily Avg: Low vs Med', 'MO Daily Avg: Low vs High', 'MO Daily Avg: Med vs High',
               'NY Daily Avg: Low vs Med', 'NY Daily Avg: Low vs High', 'NY Daily Avg: Med vs High',
               'OR Daily Avg: Low vs Med', 'OR Daily Avg: Low vs High', 'OR Daily Avg: Med vs High',
               'COL Daily Avg: Low vs Med', 'COL Daily Avg: Low vs High', 'COL Daily Avg: Med vs High']
